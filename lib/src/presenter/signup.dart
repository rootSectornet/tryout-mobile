...
import 'package:SoalOnline/src/resources/sekolahApi.dart';
...
class SignUpPresenter implements SignUpPresenterAbstract{
  ...
  void register() {
    ...
    if(this._signUpModel.sekolahId == 0){
      ...
      print(DateFormat("yyyy-mm-dd").format(this._signUpModel.tanggalLahir.toLocal()).toString());
      Map<String,String> body = <String,String>{
        ...
        "tgl_lahir":DateFormat("yyyy-MM-dd").format(this._signUpModel.tanggalLahir.toLocal()).toString(),
        "kelamin":this._signUpModel.kelamin
      };
      this._sekolahApi.register(body)
      .then((value){
        this._signUpModel.isloading = false;
        this._signUpState.refreshData(this._signUpModel);
