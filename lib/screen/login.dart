...
import 'package:SoalOnline/src/presenter/login.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Masuk",style: GoogleFonts.poppins(textStyle:TextStyle(fontSize: 34,color: Color(0xff212121),fontWeight: FontWeight.bold),)),
                Text("Ayo masuk, dan kerjakan soal soal yang telah menantimu", style: GoogleFonts.poppins(
                              ...
                              validator: (value) {
                                if (value.isEmpty) {
                                  setState(() {
                                    ...
                                    this._loginModel.usernameError = "Email tidak boleh kosong";
                                  });
                                }
                                return null;
                              },
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                InkWell(
                                  ...
                                  child:Text("Daftar Sekarang ",style: TextStyle(fontWeight: FontWeight.w600,color: Color(0xff200391)),),),
                              ],
                            ),
                          ),
                        SizedBox(height: 40,),
