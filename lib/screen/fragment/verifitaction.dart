...
import 'package:SoalOnline/src/presenter/verification.dart';
import 'package:SoalOnline/src/state/verification.dart';
...
class _VerificationScreenState extends State<VerificationScreen> implements VerificationState {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: this._verificationModel.isloading ? Loading()  :  SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Konfirmasi Akun",style: GoogleFonts.poppins(textStyle:TextStyle(fontSize: 18,color: Color(0xff0253B3),fontWeight: FontWeight.bold),)),
              Image.asset("assets/img/verfikasi.jpg",fit: BoxFit.cover),
              SizedBox(height: 30,),
              Text("Ayo, Cek Emailmu",textAlign: TextAlign.center, style: GoogleFonts.poppins(
                textStyle: TextStyle(fontSize: 14,color: Color(0xff383838)),
              )),
              Text("Masukan code yang telah kami kirim ke emailmu",textAlign: TextAlign.center, style: GoogleFonts.poppins(
